...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-i8dkhba.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-i8dkhba.containers.anotherwebservice.com/
...
```
git clone git@github.com:AtulBha/container-i8dkhba.git
cd container-i8dkhba
```
...
```
docker attach container-i8dkhba
```
